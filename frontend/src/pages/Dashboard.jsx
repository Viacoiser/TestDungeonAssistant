        ...
        {selectedCampaign ? (
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'row', minHeight: 0, position: 'relative' }}>
            ...
            <main style={{ flex: 1, padding: inspectingCharacter ? 0 : '2.5rem 2rem 3rem', overflowY: 'auto', position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column' }} className="md:pb-8 pb-24">
              ...
              <div style={{ maxWidth: ['campaigns', 'characters'].includes(activeTab) ? 960 : '100%', margin: ['campaigns', 'characters'].includes(activeTab) ? '0 auto' : '0', width: '100%' }} className="px-3 md:px-6 lg:px-8">
          ...
          <aside style={{
            ...
            height: '100%',
            padding: '2rem 1.5rem',
            display: (inspectingCharacter || !['campaigns', 'characters'].includes(activeTab)) ? 'none' : 'flex',
            flexDirection: 'column',
            gap: '2rem',
            overflowY: 'auto',
            flexShrink: 0,
