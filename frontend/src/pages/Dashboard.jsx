...
import CharacterInspect from '../components/CharacterInspect'
...
export default function Dashboard() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', background: 'var(--fantasy-bg)', fontFamily: 'Inter, sans-serif', flexDirection: 'column' }}>
      ...
      <div className="md:ml-64 flex-1 flex flex-col">
        {selectedCampaign ? (
          ...
          <>
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflowX: 'hidden', overflowY: 'visible', position: 'relative' }}>
              ...
              }} className="px-3 md:px-8 py-2 md:py-3 gap-3 md:gap-4 flex-wrap">
              {/* Search */}
              <div style={{ position: 'relative', flex: '1 1 auto', minWidth: '150px', maxWidth: '300px' }}>
                ...
                <input
                  type="text"
                  placeholder={activeTab === 'campaigns' ? 'Buscar...' : activeTab === 'characters' ? 'Buscar...' : 'Buscar...'}
                  value={searchQuery}
              ...
              {/* User info */}
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }} className="flex-shrink-0">
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', paddingRight: '1rem', borderRight: '1px solid rgba(255,255,255,0.08)', minWidth: '0' }} className="hidden sm:flex">
            ...
            {/* ── Main ── */}
            <main style={{ flex: 1, padding: inspectingCharacter ? 0 : '2.5rem 2rem 3rem', overflowY: 'auto', position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column' }} className="md:pb-8 pb-24">
              {inspectingCharacter ? (
              ...
              <div style={{ maxWidth: 960, margin: '0 auto', width: '100%' }} className="px-3 md:px-6 lg:px-8">
                  ...
                  <>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-end', justifyContent: 'space-between', gap: '1.5rem', marginBottom: '2.5rem' }}>
                      <div style={{ animation: 'fadeInUp 0.4s ease forwards' }}>
                        ...
                        <p style={{ color: 'rgba(226,209,166,0.55)', fontSize: '0.875rem', margin: 0 }} className="hidden sm:block">
          ...
          {/* ── Right Panel: Quick Stats (desktop only) ── */}
          <aside style={{
            width: 260,
            ...
            top: 0,
            padding: '2rem 1.5rem',
            display: inspectingCharacter ? 'none' : 'flex',
            flexDirection: 'column',
            gap: '2rem',
            overflowY: 'auto',
            flexShrink: 0,
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1.25rem' }}>
                ...
                <h3 style={{ fontFamily: 'Almendra, serif', fontStyle: 'normal', fontSize: '1rem', color: "var(--fantasy-gold)", fontWeight: 600, margin: 0 }}>
                  {activeTab === 'campaigns' ? 'Mis Stats' : 'Stats de Personajes'}
                </h3>
              </div>
