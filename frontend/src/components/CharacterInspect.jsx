...
export default function CharacterInspect({ character, campaignId, onClose, onUpdate, isGM, mode = 'modal' }) {
  ...
  const StatBox = ({ label, value, stat }) => (
    <div style={{
      border: '2px solid rgba(109, 82, 71, 0.3)',
      borderRadius: 4,
      padding: '0.75rem',
      textAlign: 'center',
  ...
  const TabButton = ({ id, label }) => (
    <button
      ...
      style={{
        ...
        background: activeTab === id ? 'rgba(154, 131, 122, 0.3)' : 'rgba(255,255,255,0.05)',
  ...
  return (
    <div style={mode === 'modal' ? {
      ...
      <div style={mode === 'modal' ? {
        ...
        {/* ENCABEZADO */}
        <div style={{
          background: 'linear-gradient(to bottom, rgba(50, 42, 42, 0.3), rgba(26,26,26,0.5))',
          borderBlockStart: '2px solid rgba(217,83,30,0.2)',
          borderBottom: '2px solid rgba(217,83,30,0.2)',
          borderLeft: mode === 'split-view' ? '2px solid rgba(217,83,30,0.2)' : 'none',
          ...
          <div>
            <div style={{
              fontSize: mode === 'split-view' ? '1.6rem' : '0.7rem',
            ...
            <div style={{
              fontSize: mode === 'split-view' ? '1rem' : '1.5rem',
              fontWeight: 500,
        ...
        {/* CONTENIDO */}
        <div className="character-content-main" style={{
          flex: 1,
          overflowY: 'auto',
          ...
          {activeTab === 'main' && (
            <div style={{
              display: 'grid',
              gridTemplateColumns: mode === 'split-view' ? '1fr' : '250px 1fr',
              gap: '2rem',
            }} className="character-main-grid">
                    ...
                    return (
                      <div key={stat} style={{
                        ...
                        <div style={{
                          fontSize: '0.8rem',
                          color: modifier === 0 
                          ? '#a9a9a9' : modifier > 0 ? '#86efac' : '#fca5a5',
                          fontWeight: 700,
                        }}>
