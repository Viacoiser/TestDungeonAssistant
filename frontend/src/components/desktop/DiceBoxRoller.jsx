  ...
  useEffect(() => {
    ...
    const initDiceBox = async () => {
      box = new DiceBox('#dice-box-canvas', {
        assetPath: '/assets/dice-box/', // Path to your static assets
        theme: 'default',
        themeColor: '#d4a017',
        scale: 20, // Escala ligeramente moderada
        throwForce: 4, // Reduce la fuerza para que no atraviesen las colisiones
        spinForce: 4,
        startingHeight: 8,
      })
