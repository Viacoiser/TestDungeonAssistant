 ...
 * (No-modal version de CharacterInspect)
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderBottom: '1px solid rgba(217,83,30,0.3)',
        padding: '1.5rem',
        flexShrink: 0,
      }}>
        <h2 style={{
      ...
      <div style={{
        ...
        {['main', 'stats', 'image', 'notes'].map(tab => (
          <button
            ...
            style={{
              padding: '0.5rem 1rem',
              background: activeTab === tab ? 'rgba(217,83,30,0.3)' : 'transparent',
              border: activeTab === tab ? '1px solid rgba(217,83,30,0.4)' : '1px solid rgba(255,255,255,0.07)',
              borderRadius: 6,
              color: activeTab === tab ? '#fbbf24' : 'rgba(226,209,166,0.6)',
              cursor: 'pointer',
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  <button
                    ...
                    style={{
                      flex: 1,
                      padding: '0.5rem',
                      background: editedCharacter.level > 1 ? 'rgba(217,83,30,0.3)' : 'rgba(255,255,255,0.05)',
                      border: editedCharacter.level > 1 ? '1px solid rgba(217,83,30,0.4)' : 'none',
                      borderRadius: 6,
                      color: editedCharacter.level > 1 ? '#fbbf24' : 'rgba(226,209,166,0.3)',
                  ...
                  <button
                    ...
                    style={{
                      flex: 1,
                      padding: '0.5rem',
                      background: editedCharacter.level < 20 ? 'rgba(217,83,30,0.3)' : 'rgba(255,255,255,0.05)',
                      border: editedCharacter.level < 20 ? '1px solid rgba(217,83,30,0.4)' : 'none',
                      borderRadius: 6,
                      color: editedCharacter.level < 20 ? '#fbbf24' : 'rgba(226,209,166,0.3)',
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
                  ...
                  <div style={{
                    ...
                    <p style={{ color: 'rgba(226,209,166,0.6)', fontSize: '0.65rem', margin: 0 }}>Máx</p>
                    <p style={{ color: '#fbbf24', fontSize: '1rem', fontWeight: 700, margin: '0.2rem 0 0 0' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.4rem', justifyContent: 'center', marginBottom: '0.5rem' }}>
                      <button
                        ...
                        style={{
                          ...
                          height: '28px',
                          padding: 0,
                          background: value > 3 ? 'rgba(217,83,30,0.3)' : 'rgba(255,255,255,0.05)',
                          border: value > 3 ? '1px solid rgba(217,83,30,0.4)' : 'none',
                          borderRadius: 4,
                          color: value > 3 ? '#fbbf24' : 'rgba(226,209,166,0.3)',
                      ...
                      <button
                        ...
                        style={{
                          ...
                          height: '28px',
                          padding: 0,
                          background: value < 20 ? 'rgba(217,83,30,0.3)' : 'rgba(255,255,255,0.05)',
                          border: value < 20 ? '1px solid rgba(217,83,30,0.4)' : 'none',
                          borderRadius: 4,
                          color: value < 20 ? '#fbbf24' : 'rgba(226,209,166,0.3)',
      ...
      {!editedCharacter.is_alive && (
        <div style={{
          ...
          <AlertCircle size={14} /> 💀 Este personaje está muerto
        </div>
      )}
          ...
          {showHistory && (
            <div style={{ maxHeight: '150px', overflowY: 'auto', fontSize: '0.75rem' }}>
              {history && history.length > 0 ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  {history.map((entry, idx) => (
                    <div key={idx} style={{
                      ...
                      <div style={{ fontWeight: 600, color: '#fbbf24', fontSize: '0.7rem' }}>
                      ...
                      <div style={{ fontSize: '0.7rem', color: 'rgba(226,209,166,0.5)', marginTop: '0.2rem' }}>
                        {entry.description}
                      </div>
                    </div>
                  ))}
                ...
                <div style={{ color: 'rgba(226,209,166,0.4)', textAlign: 'center', padding: '0.5rem', fontSize: '0.7rem' }}>
                  Sin cambios
                </div>
              )}
            </div>
      ...
      <div style={{
        ...
        {isGM && (
          <button
            ...
            style={{
              ...
              minWidth: '100px',
              padding: '0.6rem',
              background: editedCharacter.is_alive ? 'rgba(239,68,68,0.3)' : 'rgba(34,197,94,0.3)',
              border: editedCharacter.is_alive ? '1px solid rgba(239,68,68,0.4)' : '1px solid rgba(34,197,94,0.4)',
              color: editedCharacter.is_alive ? '#ef4444' : '#22c55e',
              borderRadius: 6,
              cursor: 'pointer',
              display: 'flex',
              alignItems: 'center',
          ...
          >
            <Skull size={16} /> {editedCharacter.is_alive ? 'Difunto' : 'Revivir'}
          </button>
        )}
        ...
        <button
          ...
          style={{
            ...
            minWidth: '100px',
            padding: '0.6rem',
            background: loading ? 'rgba(217,83,30,0.2)' : 'rgba(217,83,30,0.3)',
