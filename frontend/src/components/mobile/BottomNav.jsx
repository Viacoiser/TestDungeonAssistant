...
export default function BottomNav({ activeTab, setActiveTab }) {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 md:hidden bg-gradient-to-t from-black/80 to-black/40 backdrop-blur-md border-t border-white/10 z-50">
      ...
      {/* Encyclopedia Menu */}
      {showEncyclopedia && (
        <div className="fixed bottom-16 left-0 right-0 md:hidden bg-gradient-to-t from-black/95 to-black/80 backdrop-blur-md border-t border-white/10 z-40">
