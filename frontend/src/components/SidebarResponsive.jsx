...
/**
 * ✅ SidebarResponsive - Versión Tailwind pura, responsive
 * - hidden md:flex → Invisible en móvil, visible en tablet+
 * - md:w-64 → 256px en tablets+
 * - Mantiene todos los estilos del Sidebar original
 */
export default function SidebarResponsive({ activeTab, setActiveTab }) {
  ...
  return (
    <aside className="hidden md:flex md:flex-col md:w-64 sticky top-0 h-screen bg-black/60 border-r border-white/8 z-40 flex-shrink-0 overflow-y-auto">
