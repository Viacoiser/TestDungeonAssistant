...
export default function SpellcastingPanel({ character, onSelectItem }) {
                  ...
                  return (
                    <button
                      ...
                      onMouseEnter={(e) => {
                        ...
                        e.currentTarget.style.borderColor = 'rgba(217,83,30,0.6)'
                      }}
                      onMouseLeave={(e) => {
                ...
                {spells.map((s, i) => {
                  ...
                  return (
                    <button
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.background = prepared ? 'rgba(100,200,100,0.2)' : 'rgba(217,83,30,0.2)'
                        e.currentTarget.style.borderColor = prepared ? 'rgba(100,200,100,0.5)' : 'rgba(217,83,30,0.5)'
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = ''
                        e.currentTarget.style.borderColor = ''
