...
CREATE INDEX IF NOT EXISTS idx_character_history_created_at ON character_history(created_at);
...
-- ============================================================================
-- RLS: character_history - Campaign members can view, GM can insert
-- ============================================================================
CREATE POLICY "Members can view character history"
...
CREATE POLICY "GM can insert character history"
